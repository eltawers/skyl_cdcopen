...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="objetos.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Objetos guardados</span></a>
            </li>
        </ul>
        <!-- End of Sidebar -->
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
											<div class="input-group">
												<input id="text_books" type="text" class="form-control bg-light border-0 small" placeholder="Nombre Libro"  value="Papelucho">
												<div class="input-group-append">
													<button onclick="busqueda_libros()" class="btn btn-primary" type="button">
